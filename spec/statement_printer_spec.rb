...
describe StatementPrinter do
  ...
  describe '#print' do
    ...
    it 'responds to print when multiple statement entries present' do
      statement_entry = object_double('statement_entry', date: '01/01/19', credit: '500.00', debit: '', balance: '500.00')
      statement_entry2 = object_double('statement_entry', date: '04/01/19', credit: '1000.00', debit: '', balance: '1500.00')
      statement_entry3 = object_double('statement_entry', date: '09/01/19', credit: '', debit: '500.00', balance: '1000.00')
      expect(statement_printer.print([statement_entry, statement_entry2, statement_entry3]))
